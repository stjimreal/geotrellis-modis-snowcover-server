 ...
 *
 */
object NewTimeIngest {

  val srcPath = "/Volumes/jimDisk/cog_test/test_ingest/"
//  val srcPath = "/test_ingest/"
//  val dstPath = "/Volumes/jimDisk/Tibet-SCA/catalog_3_5/"
//  val dstPath = "/Volumes/jimDisk/Tibet-SCA/catalog_test_zorder_spark_2"
  val dstPath = "hdfs://127.0.0.1:9010/data/Tibet-SCA/catalog_test_zorder_hdfs"
//  val dstPath = "/Volumes/jimDisk/Tibet-SCA/catalog_test_zorder"
...
//    val writer = FileCOGLayerWriter(dstPath)
    val writer = HadoopCOGLayerWriter(new Path(dstPath))
